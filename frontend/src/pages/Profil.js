...
const Profil = () => {
    ...
    function suppressionProfil(){
        ...
        .then((result)=>{
            axios.post("https://busimod.com/backend/public/api/suppressionprofil/"+result.data, {
                data: {
                    popo: "salut"
                }
            }, {
    ...
    function envoiDonneesModification(nomClass, nom){
        ...
        .then((response)=>{
            axios.post("https://busimod.com/backend/public/api/updateprofil/"+response.data, modificationDonnees(nomClass, nom), {
                headers: {
